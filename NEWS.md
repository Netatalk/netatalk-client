...
- Add a supported, namespaced public API under _netatalk-client/_ for both the daemon-backed _libafpsl_ API and the
  opaque stateful _libafpclient_ transport API
