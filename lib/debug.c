...
static char *afp_command_names[] = {
    ...
    "afpSetFileDirParms", "afpChangePassword", "afpGetUserInfo", "afpGetSrvrMsg",
    "afpCreateID", "afpDeleteID", "afpResolveID", "afpExchangeFiles", "afpCatSearch",
    "Unknown 44", "Unknown 45", "Unknown 46", "Unknown 47", "afpOpenDT", "afpCloseDT",
    "Unknown 50", "afpGetIcon", "afpGetIconInfo", "afpAddAPPL", "afpRemoveAPPL",
    "afpGetAPPL", "afpAddComment",
    "afpRemoveComment", "afpGetComment", "afpByteRangeLockExt", "afpReadExt", "afpWriteExt",
    "afpGetAuthMethods", "afpLoginExt", "afpGetSessionToken", "afpDisconnectOldSession",
    ...
    "Unknown 120", "Unknown 121", "afpZzzzz", "Unknown 123", "Unknown 124",
